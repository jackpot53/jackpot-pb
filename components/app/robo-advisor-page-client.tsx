...
import {
  Search, BarChart3, ArrowUpDown, Layers,
...
type FilterTab = 'sector' | 'top200'
type SortKey = 'marketcap' | 'change'
...
const StockRow = ({
  ...
  return (
    <button
      onClick={onClick}
      className="w-full flex items-center justify-between py-2 px-2 rounded-lg transition-colors group text-left border border-transparent hover:bg-muted/60"
    >
