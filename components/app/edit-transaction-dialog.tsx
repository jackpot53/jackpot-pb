    ...
    <Dialog data-component="EditTransactionDialog" open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-lg" showCloseButton={false}>
        ...
        <TransactionForm
          ...
          formId="edit-tx-form"
          hideActions
          initialAccountType={tx.accountType}
          initialBrokerageId={tx.brokerageId}
          onSaveAccountType={async (accountType, brokerageId) => {
            await updateAssetAccountType(tx.assetId, accountType, brokerageId)
          }}
        />
      </DialogContent>
    </Dialog>
