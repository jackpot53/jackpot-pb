...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: '섹터시그널',  href: '/robo-advisor/sector', icon: Layers,    color: 'text-rose-400',    activeColor: 'text-rose-300'    },
  {
    ...
    children: [
      ...
      { label: 'Volume Oscillator', badge: '보조', href: '/robo-advisor/stock/volume-oscillator' },
      { label: 'RSI', badge: '보조', href: '/robo-advisor/stock/rsi' },
      { label: 'Stochastic', badge: '보조', href: '/robo-advisor/stock/stochastic' },
      { label: 'CCI', badge: '보조', href: '/robo-advisor/stock/cci' },
    ],
  },
