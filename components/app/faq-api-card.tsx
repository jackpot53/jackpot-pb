  ...
  return (
    <details className="group">
      ...
      <div className="mt-4 space-y-6 text-sm text-muted-foreground">
        <div>
          <div className="mb-3 inline-flex items-center gap-1.5 rounded-full bg-blue-500/15 px-2.5 py-1 text-xs font-semibold text-blue-400">
            🇰🇷 한국 주식/ETF
          </div>
        ...
        <div>
          <div className="mb-3 inline-flex items-center gap-1.5 rounded-full bg-indigo-500/15 px-2.5 py-1 text-xs font-semibold text-indigo-400">
            🇺🇸 미국 주식/ETF
          </div>
          <p className="text-sm leading-relaxed text-muted-foreground">
