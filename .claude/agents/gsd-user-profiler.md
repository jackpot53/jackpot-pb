...
<reference>
@/Users/john/dev/jackpot-pb/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/john/dev/jackpot-pb/.claude/get-shit-done/references/user-profiling.md` to load:
