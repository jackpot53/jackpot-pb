...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/john/dev/jackpot-pb/.claude
                  → checks /Users/john/dev/jackpot-pb/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/john/dev/jackpot-pb/.claude/get-shit-done
                  → writes to /Users/john/dev/jackpot-pb/.claude/get-shit-done/hooks/
...
@/Users/john/dev/jackpot-pb/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/john/dev/jackpot-pb/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/john/dev/jackpot-pb/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/john/dev/jackpot-pb/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/john/dev/jackpot-pb/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
